...
mongoFundsFindOne = {'_id': '618708fa9d2a3d6e68fa052d', 'day': '2021-11-07', 'fundsSek': 14334, 'putinSek': 1, 'yield': 577, 'yieldTax': 2}
...
def testUpdateFundsToMongo():
    ...
    objUnderTest.dbAccess.find_one.assert_called_once()
...
def testGetDaysAsStringDaysBack():
    ...
    retVal = objUnderTest.getDayAsStringDaysBack(4)
...
def testFetchDailyDataFromMongoByDate():
    ...
    objUnderTest.fetchFundsFromMongo.return_value = copy.deepcopy(mongoFundsFindOne)
...
def testFetchFundsFromMongo():
    objUnderTest = MetricHandler.MetricHandler()
    objUnderTest.dbAccess = MagicMock()
    objUnderTest.dbAccess.find_one.return_value = copy.deepcopy(mongoFundsFindOne)
